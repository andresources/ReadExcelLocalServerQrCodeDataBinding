...
public class DriverMessageAdapter extends RecyclerView.Adapter<DriverMessageAdapter.MessagesViewHolder> {

    private final Context context;

    public DriverMessageAdapter(List<msgs> msg, String from, Context context){
        this.from=from;
